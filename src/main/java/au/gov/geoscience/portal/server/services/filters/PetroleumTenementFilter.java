...
public class PetroleumTenementFilter extends AbstractFilter {
	 ...
	 */
	public PetroleumTenementFilter(String name, String holder, PetroleumTenementServiceProviderType petroleumTenementServiceProviderType) {
