...
public class PetroleumTenementController extends BasePortalController {
    ...
    HttpServletResponse response) throws Exception {
        ...
        String filter = this.petroleumTenementService.getPetroleumTenementFilter(name, tenementTypeUri, owner, tenementStatusUri, endDate,
                bbox, petroleumTenementServiceProviderType);
    ...
    public ModelAndView getPetroleumTenementCount(
        ...
        try {
            response = this.petroleumTenementService.getTenementCount(serviceUrl, tenementName, owner,
                    maxFeatures, bbox);
    ...
    public void petroleumTenementFilterDownload(
        ...
        if (!forceOutputFormat) {
            if (petroleumTenementServiceProviderType == PetroleumTenementServiceProviderType.ArcGIS) {
        ...
        String filter = this.petroleumTenementService.getPetroleumTenementFilter(name, null, owner, null, null, bbox,
                petroleumTenementServiceProviderType);


        InputStream inputStream = this.petroleumTenementService.getAllTenements(serviceUrl,
                petroleumTenementServiceProviderType.featureType(), filter, maxFeatures,
                outputFormat);
